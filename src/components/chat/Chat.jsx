...
const Chat = () => {
  ...
  const { chatId, user, isCurrentUserBlocked, isReciverBlocked} = useChatStore((state) => ({
    chatId: state.chatId,
    user: state.user
  }));
  ...
  return (
    <div className="chat">
      ...
      <div className="bottom">
        ...
        <button className="sendButton" onClick={handleSend} disabled ={isCurrentUserBlocked || isReciverBlocked}>
          Send
        </button>
      </div>
    </div>
